...
// TODO: Implement token_to_employee
// Step 2: Convert tokens to an Employee structure
// tokens[0] = name, tokens[1] = age, tokens[2] = salary
...
// TODO: Implement insert_employee
